...
*Genome-Wide Association Study (GWAS) using Multi-Locus Random-SNP-Effect Mixed Linear Models, as illustrated by Wen et al. (2017).* 

## Pré-requisitos

Antes de executar os scripts de análise, certifique-se de estar usando o **R mais atualizado**. Isso é essencial para a compatibilidade com o pacote `mrMLM` e suas dependências.
...
#- Matriz de estrutura populacional (Q)

*#- Matriz de parentesco (K)* por enquanto não fazer
